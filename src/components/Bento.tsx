  ...
  return (
    <div className=" py-24 sm:py-32">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <p className="mt-2 max-w-lg text-4xl font-semibold text-text tracking-tight text-pretty sm:text-5xl">
          Everything you need to create beautiful themes
        </p>
        <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
          <div className="relative lg:col-span-3">
            <div className="absolute inset-px rounded-lg bg-surface max-lg:rounded-t-[2rem] lg:rounded-tl-[2rem]" />
          ...
          <div className="relative lg:col-span-3">
            <div className="absolute inset-px rounded-lg bg-surface lg:rounded-tr-[2rem]" />
          ...
          <div className="relative lg:col-span-2">
            <div className="absolute inset-px rounded-lg bg-surface lg:rounded-bl-[2rem]" />
          ...
          <div className="relative lg:col-span-2">
            <div className="absolute inset-px rounded-lg bg-surface max-lg:rounded-b-[2rem] lg:rounded-br-[2rem]" />
