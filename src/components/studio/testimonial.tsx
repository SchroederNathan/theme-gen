      ...
      <section data-color="background" className="relative isolate overflow-hidden bg-background px-6 lg:px-8 min-h-full flex items-center">
        ...
        <div className="mx-auto max-w-2xl lg:max-w-4xl">
          ...
          <figure className="mt-10">
            <blockquote data-color="text" className="text-center text-xl/8 font-semibold text-text sm:text-2xl/9">
              <p>
            ...
            <figcaption className="mt-10">
              ...
              <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                <div data-color="text" className="font-semibold text-text">Nathan Schroeder</div>
                <svg width={3} height={3} viewBox="0 0 2 2" aria-hidden="true" className="fill-text">
                  <circle r={1} cx={1} cy={1} />
                </svg>
                <div data-color="muted" className="text-muted">CEO of ThemeGen</div>
              </div>
            </figcaption>
          </figure>
        </div>
