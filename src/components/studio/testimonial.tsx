...
export default function Testimonial() {
    return (
      <section className="relative isolate overflow-hidden bg-background px-6 lg:px-8 min-h-full flex items-center">
        ...
        <div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-surface shadow-xl ring-1 shadow-primary/10 ring-border sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center" />
          ...
          <figure className="mt-10">
            ...
            <figcaption className="mt-10">
              ...
              <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                <div className="font-semibold text-onSurface">Nathan Schroeder</div>
                <svg width={3} height={3} viewBox="0 0 2 2" aria-hidden="true" className="fill-onSurface">
