  ...
  return (
    <div className="relative group h-full">
      {(() => {
        ...
        return (
          <div
            className="absolute -top-2 -left-2 z-10 p-1 rounded-full bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-200 shadow-sm flex items-center justify-center"
            title={
              badgeStage === "success"
      ...
      <button
        ...
        className="absolute -top-2 -right-2 p-1 rounded-full bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-200 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-neutral-100 dark:hover:bg-neutral-800"
        title={isLocked ? "Unlock color" : "Lock color"}
      >
        {isLocked ? <Lock size={14} className="text-current" /> : <Unlock size={14} className="text-current" />}
      </button>
    </div>
  );
}
