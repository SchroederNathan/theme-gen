  ...
  return (
    <div className="relative group h-full">
        ...
        return (
          ...
          >
            {badgeStage === "success" ? (
              ...
              <AlertTriangle size={9} strokeWidth={2.75} className="text-white" />
            ) : (
              <X size={9} strokeWidth={2.75} className="text-white" />
            )}
          </div>
        );
      })()}
      ...
      <button
        ...
        className="absolute -top-2 -right-2 p-1 rounded-full bg-neutral-50 border border-neutral-200 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-neutral-100"
